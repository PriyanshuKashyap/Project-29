...
function setup() {
    ...
    block1A = new Box(270, 350, 30, 40, rgb(141, 209, 241));
    block2A = new Box(295, 350, 30, 40, rgb(141, 209, 241));
    block3A = new Box(320, 350, 30, 40, rgb(141, 209, 241));
    block4A = new Box(345, 350, 30, 40, rgb(141, 209, 241));
    block5A = new Box(370, 350, 30, 40, rgb(141, 209, 241));
    block6A = new Box(395, 350, 35, 40, rgb(141, 209, 241));
    block7A = new Box(420, 350, 35, 40, rgb(141, 209, 241));

    block8A = new Box(295, 325, 30, 40, "pink");
    block9A = new Box(320, 325, 30, 40, "pink");
    block10A = new Box(345, 325, 30, 40, "pink");
    block11A = new Box(370, 325, 30, 40, "pink");
    block12A = new Box(395, 325, 35, 40, "pink");

    block13A = new Box(320, 300, 30, 40, rgb(64, 224, 208));
    block14A = new Box(345, 300, 30, 40, rgb(64, 224, 208));
    block15A = new Box(370, 300, 30, 40, rgb(64, 224, 208));
    block16A = new Box(345, 275, 30, 40, 150);

    
    block1B = new Box(645, 240, 30, 40, rgb(141, 209, 241));
    block2B = new Box(670, 240, 30, 40, rgb(141, 209, 241));
    block3B = new Box(695, 240, 30, 40, rgb(141, 209, 241));
    block4B = new Box(720, 240, 30, 40, rgb(141, 209, 241));
    block5B = new Box(745, 240, 30, 40, rgb(141, 209, 241));

    block6B = new Box(670, 215, 30, 40, rgb(64, 224, 208));
    block7B = new Box(695, 215, 30, 40, rgb(64, 224, 208));
    block8B = new Box(720, 215, 30, 40, rgb(64, 224, 208));

    block9B = new Box(695, 190, 30, 40, "pink");
